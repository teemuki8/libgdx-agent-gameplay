...
- `io.github.teemuki8:gameplay-bullet` — optional bounded Bullet collision queries, authoritative
  capsule movement, and stable-ID primitive rigid dynamics. Applications own world lifetime and natives.
